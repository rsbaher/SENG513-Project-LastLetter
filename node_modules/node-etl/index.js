((api,_m,ETLData,JsDK,JFile)=>{
     ...
     */
      ...
      api.extract_jfile=function(what,how){
          return ETLData.build(what.lines.filter(how.ignore).map((line)=> how.process(line,how)));
      };
...
/**
*   opts.headers //Default is the attribute
*   opts.joiner : "," or (row)=>
*   opts.ignore:(row)=>
*/
      api.transform=function(data,opts){
          return new ETLData(data).transform(opts);
      }



      _m.exports=api;
})({},module,require(`${__dirname}/model/ETLData.js`),require('x-class'),require('jfile'))
