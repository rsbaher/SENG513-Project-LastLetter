$(function() {
    ...
    // TODO only init the page that is being shown
...
// Login in done
// TODO login and logout button should not both be visible at the same time
...
// Receive incoming chat message at datetime from a user
    socket.on('chat', function(msg, date, userName, color) {
        ...
        console.log('Receiving broadcast from ' + userName + ': ' + msg);
